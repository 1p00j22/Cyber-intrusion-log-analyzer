...
if uploaded_file:
    ...
    # ==============================
    le = LabelEncoder()
    y_true = le.fit_transform(y_true)   # string → 0,1
...
# ==============================
st.markdown("---")
st.markdown("🚀 Cyber Intrusion Detection System")
